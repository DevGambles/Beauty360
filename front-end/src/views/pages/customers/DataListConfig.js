  ...
  return (
    <div className="data-list-header d-flex justify-content-between flex-wrap">
      <div className="actions-left d-flex flex-wrap">
        <Button class="mt-sm-0 mt-2" color="primary" onClick={e => downloadCSV(props.data)}>Export</Button>
      </div>
...
const downloadCSV = (array) => {
  ...
  if (csv == null) return;
  const filename = `ClientList-${serviceType}-${new Date()}.csv`;
...
class DataListConfig extends Component {
  ...
  componentDidMount() {
    serviceType = this.props.service.value;
    this.props.getData({service: serviceType})
  }
